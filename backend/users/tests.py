...
class TestAdminInterface(TestCase):
    ...
    def setUp(self) -> None:
        ...
        from users.admin import CustomUserAdmin, NurseProfileAdmin, PatientProfileAdmin
...
class TestNurseDocumentModel(TestCase):
    ...
    def test_create_nurse_document(self) -> None:
        ...
        from users.models import DocumentStatus, DocumentType, NurseDocument
    ...
    def test_unique_constraint_per_document_type(self) -> None:
        ...
        from users.models import DocumentType, NurseDocument
