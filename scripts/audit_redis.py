...
# Import sanitize_redis_url from config.redis_utils
from config.redis_utils import sanitize_redis_url
...
spec = importlib.util.spec_from_file_location(
    "config.settings", os.path.join(os.getcwd(), "config", "settings.py")
)
...
def check_redis_cache():
    ...
    try:
        ...
        print(f"    Target: {sanitize_redis_url(location)}")
